...
export function Login() {
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[1fr_minmax(0,460px)]">
      {/* Left — unified campus scene */}
      <div className="login-scene relative hidden overflow-hidden lg:block">
        {/* Ground: full grass plane matching the image green */}
        <div className="login-grass" />

        {/* Perspective walkway extending from school door to bottom */}
        <div className="login-walkway" />
        <div className="login-walkway-lines" />

        {/* Atmospheric depth: subtle fog at horizon */}
        <div className="login-atmosphere" />

        {/* School image — anchored to ground, centered */}
        <div className="login-school">
          <img src="/logo-programa.png" alt="EduAlerta" draggable={false} />
        </div>
